...
for(const st of ['ossuary','royal','chapel','forge','ship','guard','kitchen','earth','drowned']){
...
console.log('room patterns: nine interiors invariant under camera movement and clipped to room bounds.');
