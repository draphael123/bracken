...
try {
  const r = await pg.evalp(`(async()=>{const rep=await BK.playtest({levels:['moor'],heroes:${JSON.stringify(heroes)},mode:'both',quiet:true,log:false});return rep.text;})()`, 1800000);
  console.log(r);
