// campaign-order.mjs — THE ORDER A PLAYER WALKS THE CAMPAIGN IN, worked out once and imported by everything
// that needs it. Node only: no page, no port, no Chrome.
//
