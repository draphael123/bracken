...
for (const t of ['tells', 'comments', 'floaters', 'audit', 'content-audit', 'talents', 'progression', 'progression-runtime', 'reaper-input', 'traps', 'signs', 'killzones', 'collectables', 'keys', 'elites', 'spawns', 'deadends', 'rafts', 'render-layers', 'room-patterns', 'heat', 'queen-comb', 'crown-requests', 'gallery-runtime', 'waterfall-joins', 'paladin-enrage', 'spurs-runtime', 'additional-areas', 'additional-areas-runtime', 'keep', 'keep-runtime', 'storm-ship', 'storm-ship-runtime', 'haunted-coast', 'haunted-coast-runtime', 'tower-finish', 'tower-finish-runtime', 'sea-requests', 'sea-runtime', 'shop-theme', 'dressing', 'runtime-footing', 'bridge-props', 'light-support', 'readability', 'town-live', 'waymeet-cleanup', 'owl-lamps', 'belfry', 'moor-wind', 'watchtowers', 'spore-loop', 'combat-feel', 'attack-animation', 'ambush-single', 'lab-clock', 'combat-replay', 'combat-results-test', 'king-refill', 'pilot-actions', 'pyre-pilot', 'herald-pirate', 'cdp-recovery', 'swim-chain']) results.push(run(t, process.execPath, ['tools/' + t + '.mjs']));
