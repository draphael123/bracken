...
for (const t of ['tells', 'comments', 'floaters', 'audit', 'content-audit', 'talents', 'traps', 'signs', 'killzones', 'collectables', 'deadends']) results.push(run(t, process.execPath, ['tools/' + t + '.mjs']));
