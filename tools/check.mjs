...
for (const t of ['tells', 'comments', 'floaters', 'audit', 'content-audit', 'talents', 'traps', 'signs', 'killzones', 'collectables', 'keys', 'elites', 'spawns', 'deadends', 'rafts', 'render-layers', 'heat', 'queen-comb', 'dressing', 'runtime-footing', 'bridge-props', 'light-support', 'readability', 'town-live', 'owl-lamps', 'belfry', 'moor-wind']) results.push(run(t, process.execPath, ['tools/' + t + '.mjs']));
