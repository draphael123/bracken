...
//   camera-fill  the follow camera's flat-ground foot line (CAM_FOOT), the ground's fade-to-dark by depth, and the
//             Hornet Queen's and the Grandmother's arenas framing without the boss plate over a fighter
