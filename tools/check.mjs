...
//   phase-two every boss that picks its turns from a phase-keyed list asks something NEW at half health:
//             an attack that stops, one that comes round oftener, or an order the old reads no longer fit (A10)
