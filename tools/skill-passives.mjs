...
for(const [h,id]of[['knight','flurry'],['pyro','heatShield'],['paladin','sanctuary'],['pirate','shareOut'],['reaper','gleaner'],['warden','keenPoint'],['geomancer','geoRumble']]){const values=[];for(const enabled of [false,true]){
 ...
 if(h==='geomancer'){BK.P.tremor=0;BK.geo().gainTremor(10);value=BK.P.tremor;}
