/* tools/hanging-walk.mjs [heroes] - F9 for THE HANGING VILLAGE (docs/briefs/hanging-village-rework.md): the in-page play bot
...
try {
  const r = await pg.evalp(`(async()=>{const rep=await BK.playtest({levels:['hanging'],heroes:${JSON.stringify(heroes)},mode:'both',quiet:true,log:false});return rep.text;})()`, 1800000);
  console.log(r);
