...
/* THE LEADFOOT IS GONE (Daniel, 2026-09-25: 'the single scuba enemy'), and THE DROWNED KNIGHTS stand where he stood - fewer than a
   crowd, none in the King's arena, and the captain holding the door (their attacks: tools/drowned-knights.mjs) */
assert(!keep.ents.some(e=>e.t==='leadfoot'),'the Leadfoot is gone');
