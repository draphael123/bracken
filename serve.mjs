...
const TYPES = {
  ...
  '.png': 'image/png', '.ogg': 'audio/ogg', '.wav': 'audio/wav', '.mp3': 'audio/mpeg', '.jpg': 'image/jpeg', '.webmanifest': 'application/manifest+json',
};
...
}).listen(PORT, () => console.log(`bracken → http://localhost:${PORT}`));
