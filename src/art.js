...
const MAP_ICON_DEFS = {
  ...
  spire: g => { circle(g, 4, 3, 2.6, '#e0a030'); circle(g, 4, 3, 1.8, '#ffd36b'); px(g, 0, 3, '#ffd36b'); px(g, 8, 3, '#ffd36b'); px(g, 1, 0, '#e0a030'); px(g, 7, 0, '#e0a030'); fillPoly(g, [[4, 1], [5, 8], [3, 8]], '#8b8378'); px(g, 4, 1, '#dfe8ee'); },   /* THE SUNSPIRE: the spire against the sun it is named for (was a grey spike on its own) */
  moor: g => { line(g, 1, 3, 7, 3, '#c9d4dc'); line(g, 2, 5, 8, 5, '#a8a090'); line(g, 1, 7, 6, 7, '#c9d4dc'); },
  storm: g => { rect(g, 2, 5, 5, 3, '#8b8378'); px(g, 2, 4, '#8b8378'); px(g, 4, 4, '#8b8378'); px(g, 6, 4, '#8b8378'); px(g, 4, 6, '#2a2630'); ellipse(g, 4, 1, 4, 1.5, '#4a4a5a'); px(g, 5, 2, '#ffe27a'); px(g, 6, 3, '#ffe27a'); },   /* STORMHOLD: a pale keep under a storm cloud with lightning in it (was a dark block) */
  ...
  lamplit: g => { circle(g, 4, 2, 2.4, '#7a6a3a'); rect(g, 3, 1, 3, 3, '#3a3444'); rect(g, 4, 2, 1, 1, '#ffe27a'); px(g, 3, 2, '#ffd36b'); px(g, 5, 2, '#ffd36b'); rect(g, 4, 4, 1, 3, '#5f5a52'); rect(g, 2, 7, 5, 1, '#5f5a52'); },   /* THE LAMPLIT STREET: a lamp that is LIT, glow and all (was an unlit grey post) */
  deep: g => { circle(g, 4, 1, 1.2, '#9ab8c8'); px(g, 4, 1, '#1b2a3a'); rect(g, 4, 2, 1, 5, '#9ab8c8'); rect(g, 2, 3, 5, 1, '#9ab8c8'); px(g, 1, 6, '#9ab8c8'); px(g, 7, 6, '#9ab8c8'); rect(g, 2, 7, 5, 1, '#9ab8c8'); px(g, 0, 5, '#9ab8c8'); px(g, 8, 5, '#9ab8c8'); },   /* THE DEEP: an anchor, the thing that goes all the way down (was a purple squiggle) */
  ...
  unburied: g => { rect(g, 2, 0, 1, 9, '#8a6a44'); fillPoly(g, [[3, 1], [8, 1], [7, 3], [8, 5], [3, 5]], '#8f2f28'); px(g, 5, 2, '#c9463d'); px(g, 7, 4, '#5a1a18'); px(g, 3, 5, '#5a1a18'); },   /* THE UNBURIED FIELD: a tattered war standard, the banner that raises the dead */
