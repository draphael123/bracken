...
function theDeep() {
  ...
  ent('siren', 62, 182); ent('urchin', 14, 174); ent('urchin', 92, 170);
  ...
  ent('watch', 178, 198, { face: -1 }); ent('watch', 200, 198, { face: -1 }); ent('wight', 165, 198, { face: 1 }); ent('wight', 190, 198, { face: 1 });
