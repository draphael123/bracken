...
const GARRISON = {
  ...
  burial: [['zombie', 16], ['husk', 9], ['wight', 14], ['bat', 13], ['bonegob', 10], ['bonecorsair', 8], ['boo', 11], ['lanternshade', 5], ['haunt', 8], ['spider', 6]],   /* and something that SHOOTS: over 1,140 tiles nothing in here could reach the hero across a room */   /* forty-four zombies and nothing else was the whole roster under the hill */
