...
const TRACK_GAIN = { cave: 2.1, adventure: 1.7, theme3: 0.8, theme4: 0.75, reef: 1.5, longwater: 1.25, flotilla: 1.0 };
...
export const MUSIC_NAMES = ['theme', 'theme2', 'stockade', 'cave', 'theme3', 'theme4', 'town', 'sunspire', 'adventure', 'stormhold', 'highcrown', 'longwater', 'reef', 'flotilla', 'boss', 'boss2', 'king', 'roc', 'queen', 'select', 'ending'];
