...
const DIE = {
  ...
  scalder() { gob(1.05, 0.55) || tone('sawtooth', 300, 80, 0.3, 0.18); SFX.clatter(); noise(0.6, 0.18, 1400, 0.4, 0.08); tone('sine', 120, 50, 0.4, 0.12, 0.1); /* the pot goes over and the pitch hisses out */ },
...
const HURT = {
  ...
  scalder() { gobH(1.05) || tone('square', 520, 330, 0.08, 0.13); noise(0.1, 0.08, 1200, 0.6, 0.02); /* and the pot rocks under him */ },
