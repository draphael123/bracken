...
export const AMBUSH_LEADERS = new Set(['husk','shield','archer','brute','pike','troll','tideguard','boarder','hedgeknight','armour','hopper','goat','cutlass','watch','scarecrow','thorn']);
...
export const AMBUSH_HEALTH = {wood:1.7,marsh:2.2,stockade:2.5,spore:6,kings:2,scree:1.7,hanging:2.2,spire:1.5,moor:1.6,storm:3,longwater:1.8,flotilla:1.4,hurricane:2.1,lamplit:2.8,causeway:1.9,waymeet:1.3,fields:2,mage:1,burial:2};
export const AMBUSH_CAPTAINS={marsh:'thorn',kings:'archer',scree:'troll',moor:'goat',hurricane:'cutlass',lamplit:'watch',fields:'scarecrow',burial:'husk'};   /* the caverns' dead have no captains of the usual kinds: the grave husk leads their rooms */
