...
export const THROWN = new Set(['updateForgemaster|hurlTell', 'updateForgemaster|dragTell',
  ...
  'updatePyromander|wallTell',      // THE FIRE WALL: five flames marching along the floor, and floor fire is unblockable
...
export const QUIET = new Set(['updateTollmaster|floodTell', 'updateTollmaster|darkTell', 'updateLampreeve|snuffTell',
  ...
  'updateGraveWarden|tollTell']);   // THE GRAVE WARDEN TOLLS: the dead climb out and strike on their own marks; the bell strikes nobody     // THE GOBLIN PRIEST'S RITE mends and blesses its own side and touches nobody: it says THE RITE, not a mark
...
export const BY_HAND = {
 'bellguard|vaultHookTell':'!', 'bellguard|vaultSpearTell':'!', 'bellguard|vaultRingTell':'!!', 'bellguard|vaultPressureTell':'!!', 'bellguard|vaultBandTell':'!!',
  ...
  'broom|sweepTell':'!',   /* THE WITCHLIGHT STAIR's aqueduct broom (sweepBroom, by hand): a sweep at the ankles a shield braces against */
...
export const MARK = {
  ...
  'bellguard|vaultBandTell': '!!', 'bellguard|vaultHookTell': '!', 'bellguard|vaultPressureTell': '!!', 'bellguard|vaultRingTell': '!!', 'bellguard|vaultSpearTell': '!', 'berserker|flailTell': '!',
  'berserker|windTell': '!!', 'boarder|shootTell': '!', 'boarder|slashTell': '!', 'boarder|swingTell': '!', 'boarder|throwTell': '!', 'bonecorsair|cleaveTell': '!!',
  ...
  'courtier|clawTell': '!', 'crab|lungeTell': '!', 'crab|pinchTell': '!', 'crab|snapTell': '!', 'crab|strikeTell': '!', 'crab|thrustTell': '!',
  'crossbow|aim': '!', 'crossbow|cutTell': '!', 'crossbow|leapTell': '!!', 'crossbow|shout': '!', 'crossbow|stabTell': '!', 'crossbow|swingTell': '!',
  'cutlass|shootTell': '!', 'cutlass|slashTell': '!', 'cutlass|swingTell': '!', 'cutlass|throwTell': '!', 'cutter|raise': '!', 'drownedking|anchorTell': '!',
  'drownedking|debtTell': '!', 'drownedking|diveTell': '!!', 'drownedking|gulpTell': '!!', 'drownedking|haulTell': '!', 'drownedking|ramTell': '!!', 'drownedking|slamTell': '!!',
  'drownedking|whirlTell': '!!', 'drunk|bottleTell': '!!', 'drunk|lobTell': '!', 'eel|leapTell': '!', 'eel|lungeTell': '!', 'eel|pinchTell': '!',
  'eel|snapTell': '!', 'eel|strikeTell': '!', 'eel|thrustTell': '!', 'familiar|slamTell': '!!', 'familiar|spitTell': '!', 'familiar|swipeTell': '!',
  ...
  'frog|inhaleTell': '!', 'frog|tongueTell': '!', 'gar|lungeTell': '!', 'goat|charge': '!', 'gobmage|boltTell': '!', 'gobmage|runeTell': '!!',
  'gobpriest|riteTell': '', 'golem|shroudTell': '', 'golem|stompTell': '!!', 'golem|sweepTell': '!!', 'golem|throwTell': '!', 'gqueen|chandTell': '!!',
  'gqueen|chargeTell': '!!', 'gqueen|crownTell': '!', 'gqueen|decreeTell': '!', 'gqueen|gDropTell': '!!', 'gqueen|gLeapTell': '', 'gqueen|leapTell': '!!',
  ...
  'gravewarden|digTell': '!!', 'gravewarden|swingTell': '!!', 'gravewarden|tollTell': '', 'gravewarden|tossTell': '!', 'grub|spit': '!', 'harbormaster|anchorTell': '!',
  'harbormaster|harpoonTell': '!', 'harbormaster|highTell': '!!', 'harbormaster|lowTell': '!!', 'harbormaster|pressureTell': '!!', 'harbormaster|twinTell': '!!', 'hare|run': '!',
  'harpy|aim': '!', 'haunt|throwTell': '!', 'hearthgob|raise': '!', 'heavy|grabTell': '!!', 'heavy|raise': '!!', 'heavy|slashTell': '!',
  'heavy|windUp': '!', 'hedgeknight|aim': '!', 'hedgeknight|cutTell': '!', 'hedgeknight|leapTell': '!!', 'hedgeknight|shout': '!', 'hedgeknight|stabTell': '!',
  'hedgeknight|swingTell': '!', 'hedgewarden|cutTell': '!', 'hedgewarden|rushTell': '!', 'hedgewarden|thornTell': '!!', 'herald|callTell': '', 'herald|glideTell': '!!',
  'herald|hurlTell': '!', 'herald|maelTell': '!', 'herald|raise': '!!', 'herald|spearTell': '!', 'herald|sweepTell': '!!', 'herald|thrustTell': '!',
  'heronfoe|lungeTell': '!', 'heronfoe|pinchTell': '!', 'heronfoe|snapTell': '!', 'heronfoe|strikeTell': '!', 'heronfoe|thrustTell': '!', 'homunculus|flaskTell': '!!',
  'homunculus|pounceTell': '!', 'homunculus|poundTell': '!!', 'homunculus|scuttleTell': '!!', 'homunculus|swipeTell': '!', 'horn|tell': '', 'horn|whistleTell': '',
  ...
  'king|grabTell': '!!', 'king|liftTell': '!!', 'king|shoutTell': '!!', 'king|slamTell': '!!', 'kraken|geyserTell': '!!', 'kraken|grabTell': '!!',
  ...
  'lampreeve|snuffTell': '', 'lampreeve|sweepTell': '!', 'lancer|chargeTell': '!', 'lancer|cutTell': '!', 'lancer|swipeTell': '!', 'lance|bashTell': '!!',
  ...
  'lookout|swingTell': '!', 'lookout|throwTell': '!', 'manta|diveTell': '!', 'marine|shootTell': '!', 'marine|slashTell': '!', 'marine|swingTell': '!',
  ...
  'merrowcaller|surgeTell': '!!', 'merrowspear|throwTell': '!', 'mimic|biteTell': '!', 'miner|smashTell': '', 'miner|swingTell': '!', 'mother|capClapTell': '!!',
  ...
  'mother|sporeVolleyTell': '!', 'mother|sporeWheelTell': '!', 'netter|biteTell': '!', 'netter|castTell': '!', 'netter|dive': '!', 'netter|hookTell': '!',
  'netter|swellTell': '!', 'owl|fanTell': '!', 'owl|hootTell': '!!', 'owl|riseUp': '!!', 'owl|screechTell': '!', 'owl|skimTell': '!!',
  'petrel|biteTell': '!', 'petrel|castTell': '!', 'petrel|dive': '!', 'petrel|diveTell': '!', 'petrel|hookTell': '!', 'petrel|swellTell': '!',
  'piece|nipTell': '!', 'pike|elSweepTell': '!', 'pike|tell': '!', 'ploughman|chargeTell': '!!', 'ploughman|goadTell': '!', 'ploughman|headTell': '!',
  ...
  'puffer|hookTell': '!', 'puffer|swellTell': '!', 'pumpkin|biteTell': '!', 'pumpkin|puffTell': '!!', 'pyromander|dropTell': '!!', 'pyromander|emberTell': '!',
  'pyromander|jetTell': '!', 'pyromander|staffTell': '!', 'pyromander|ventTell': '!!', 'pyromander|wallTell': '!!', 'quarter|shootTell': '!!', 'quarter|slashTell': '!',
  'quarter|stanceTell': '!!', 'queen|aim': '!', 'queen|slamHang': '!', 'ram|buttTell': '!', 'ram|callTell': '', 'ram|leapTell': '!!',
  'ram|lower': '!', 'ram|rear': '!', 'ram|stampTell': '!!', 'ram|tossTell': '!!', 'reefmaw|biteTell': '!', 'reefmaw|riseTell': '!',
  'reefmaw|spitTell': '!', 'reefmaw|thrashTell': '!', 'rockgoblin|throw': '!', 'roc|grabTell': '!!', 'roc|gustTell': '', 'roc|roofTell': '!',
  ...
  'sailor|castTell': '!', 'sailor|dive': '!', 'sailor|hookTell': '!', 'sailor|swellTell': '!', 'scarecrow|swipeTell': '!', 'scout|lungeTell': '!',
  'scout|pinchTell': '!', 'scout|snapTell': '!', 'scout|strikeTell': '!', 'scout|thrustTell': '!', 'seawitch|callTell': '!!', 'shield|elChargeTell': '!',
  'shield|elWallTell': '', 'shield|shoveTell': '!', 'siren|lungeTell': '!', 'siren|pinchTell': '!', 'siren|snapTell': '!', 'siren|strikeTell': '!',
  'siren|thrustTell': '!', 'snuffer|snuffTell': '', 'snuffer|swipeTell': '!', 'soldier|grabTell': '!!', 'soldier|raise': '!!', 'soldier|slashTell': '!',
  'soldier|windUp': '!', 'spider|drop': '!', 'spider|dropTell': '!', 'spider|reelTell': '!', 'spider|spitTell': '!', 'sprig|biteTell': '!',
  ...
  'suncatcher|shardTell': '!', 'suncatcher|spireTell': '!!', 'swornsword|aim': '!', 'swornsword|cutTell': '!', 'swornsword|leapTell': '!!', 'swornsword|shout': '!',
  'swornsword|stabTell': '!', 'swornsword|swingTell': '!', 'thorn|wind': '!', 'tideguard|lungeTell': '!', 'tideguard|pinchTell': '!', 'tideguard|snapTell': '!',
  'tideguard|strikeTell': '!', 'tideguard|thrustTell': '!', 'tidemarauder|harpoonTell': '!', 'tidemarauder|rakeTell': '!!', 'tollmaster|blackoutTell': '!', 'tollmaster|darkTell': '',
  ...
  'turtle|snapTell': '!', 'turtle|strikeTell': '!', 'turtle|thrustTell': '!', 'undeadmage|fireTell': '!', 'undeadmage|handTell': '!', 'undeadmage|iceTell': '!',
  'undeadmage|markTell': '!!', 'undeadmage|poisonTell': '!', 'undeadmage|stormTell': '!!', 'urchin|biteTell': '!', 'urchin|castTell': '!', 'urchin|dive': '!',
  'urchin|hookTell': '!', 'urchin|swellTell': '!', 'wasp|stingTell': '!', 'watch|sweepTell': '!', 'watch|thrustTell': '!', 'windcaller|howlTell': '',
