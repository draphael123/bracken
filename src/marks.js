...
export const BY_HAND = {
 'bellguard|vaultHookTell':'!', 'bellguard|vaultSpearTell':'!', 'bellguard|vaultRingTell':'!!', 'bellguard|vaultPressureTell':'!!', 'bellguard|vaultBandTell':'!!',
  ...
  'broom|sweepTell':'!',
  'winchmaster|reverseTell':'','winchmaster|sendTell':'!!','winchmaster|cutTell':'!!','winchmaster|leverTell':'!',   /* THE WINCHMASTER (winchmaster.js, by hand): the reverse throws no blow, so it is QUIET */
...
export const MARK = {
  ...
  'brute|wind': '!', 'burieddead|callTell': '', 'burieddead|clawTell': '!!', 'burieddead|cleaveTell': '!', 'burieddead|eruptTell': '!!', 'burieddead|sinkTell': '',
  'burieddead|slamTell': '!!', 'burngob|swingTell': '!', 'captain|hookTell': '!', 'captain|kegTell': '!!', 'captain|sabreTell': '!', 'captain|shootTell': '!!',
  'chief|bashWind': '!!', 'chief|crouch': '!!', 'chief|rainAim': '!', 'chief|raise': '!!', 'chief|slashWind': '!', 'chief|whirlWind': '!',
  'chief|wind': '!', 'closedhelm|bashTell': '!!', 'closedhelm|cutTell': '!', 'closedhelm|judgeTell': '!', 'closedhelm|oathTell': '!!', 'closedhelm|radianceTell': '!!',
  'closedhelm|thrustTell': '!', 'courtier|clawTell': '!', 'crab|lungeTell': '!', 'crab|pinchTell': '!', 'crab|snapTell': '!', 'crab|strikeTell': '!',
  'crab|thrustTell': '!', 'crossbow|aim': '!', 'crossbow|cutTell': '!', 'crossbow|leapTell': '!!', 'crossbow|shout': '!', 'crossbow|stabTell': '!',
  'crossbow|swingTell': '!', 'cutlass|shootTell': '!', 'cutlass|slashTell': '!', 'cutlass|swingTell': '!', 'cutlass|throwTell': '!', 'cutter|raise': '!',
  ...
  'drownedking|slamTell': '!!', 'drownedking|whirlTell': '!!', 'drunk|bottleTell': '!!', 'drunk|lobTell': '!', 'eel|leapTell': '!', 'eel|lungeTell': '!',
  'eel|pinchTell': '!', 'eel|snapTell': '!', 'eel|strikeTell': '!', 'eel|thrustTell': '!', 'familiar|slamTell': '!!', 'familiar|spitTell': '!',
  'familiar|swipeTell': '!', 'familiar|walk': '!', 'farmhand|swingTell': '!', 'feeler|lashTell': '!', 'fledgling|peckTell': '!', 'forgemaster|anvilTell': '!!',
  'forgemaster|bellowsTell': '!', 'forgemaster|breathTell': '!!', 'forgemaster|dragTell': '!!', 'forgemaster|dropTell': '!!', 'forgemaster|hurlTell': '!!', 'forgemaster|ladleTell': '!!',
  'forgemaster|leapTell': '', 'forgemaster|pourTell': '!!', 'forgemaster|slamTell': '!!', 'forgemaster|sprayTell': '!', 'forgemaster|tongsTell': '!', 'forgemaster|whirlTell': '!!',
  'frog|crouch': '!', 'frog|inhaleTell': '!', 'frog|tongueTell': '!', 'gaffer|haftTell': '!', 'gaffer|hookTell': '!!', 'gargoyle|diveTell': '!!',
  'gargoyle|flareTell': '!!', 'gargoyle|gustTell': '!', 'gargoyle|spitTell': '!', 'gar|lungeTell': '!', 'goat|charge': '!', 'gobmage|boltTell': '!',
  'gobmage|runeTell': '!!', 'gobpriest|riteTell': '', 'golem|shroudTell': '', 'golem|stompTell': '!!', 'golem|sweepTell': '!!', 'golem|throwTell': '!',
  'gqueen|chandTell': '!!', 'gqueen|chargeTell': '!!', 'gqueen|crownTell': '!', 'gqueen|decreeTell': '!', 'gqueen|gDropTell': '!!', 'gqueen|gLeapTell': '',
  ...
  'hedgeknight|stabTell': '!', 'hedgeknight|swingTell': '!', 'hedgewarden|cutTell': '!', 'hedgewarden|rushTell': '!', 'hedgewarden|thornTell': '!!', 'herald|callTell': '',
  ...
  'lance|sweepTell': '!!', 'lance|thrustTell': '!', 'lance|vaultTell': '!', 'lance|whirlTell': '!!', 'lanternshade|flareTell': '!', 'leadfoot|anchorTell': '!!',
  'leadfoot|plantTell': '!', 'leadfoot|sweepTell': '!', 'lookout|shootTell': '!', 'lookout|slashTell': '!', 'lookout|swingTell': '!', 'lookout|throwTell': '!',
  'manta|diveTell': '!', 'marine|shootTell': '!', 'marine|slashTell': '!', 'marine|swingTell': '!', 'marine|throwTell': '!', 'marshlight|flareTell': '!',
  ...
  'mother|sporeWheelTell': '!', 'netter|biteTell': '!', 'netter|castTell': '!', 'netter|dive': '!', 'netter|hookTell': '!', 'netter|swellTell': '!',
  'owl|fanTell': '!', 'owl|hootTell': '!!', 'owl|riseUp': '!!', 'owl|screechTell': '!', 'owl|skimTell': '!!', 'petrel|biteTell': '!',
  ...
  'puffer|swellTell': '!', 'pumpkin|biteTell': '!', 'pumpkin|puffTell': '!!', 'pyromancer|emberTell': '!', 'pyromancer|jetTell': '!', 'pyromancer|staffTell': '!',
  'pyromancer|stepTell': '!', 'pyromancer|ventTell': '!!', 'pyromancer|wallTell': '!!', 'pyromancer|wispTell': '', 'quarter|shootTell': '!!', 'quarter|slashTell': '!',
  ...
  'scout|pinchTell': '!', 'scout|snapTell': '!', 'scout|strikeTell': '!', 'scout|thrustTell': '!', 'seawitch|callTell': '!!', 'sheargob|cutTell': '!!',
  'sheargob|snipTell': '!', 'shield|elChargeTell': '!', 'shield|elWallTell': '', 'shield|shoveTell': '!', 'siren|lungeTell': '!', 'siren|pinchTell': '!',
  'siren|snapTell': '!', 'siren|strikeTell': '!', 'siren|thrustTell': '!', 'snuffer|snuffTell': '', 'snuffer|swipeTell': '!', 'soldier|grabTell': '!!',
  'soldier|raise': '!!', 'soldier|slashTell': '!', 'soldier|windUp': '!', 'spider|drop': '!', 'spider|dropTell': '!', 'spider|reelTell': '!',
  'spider|spitTell': '!', 'sprig|biteTell': '!', 'stormshaman|callTell': '!!', 'strawking|baleTell': '!!', 'strawking|callTell': '', 'strawking|forkTell': '!',
  ...
  'temperer|shoveTell': '!', 'thorn|wind': '!', 'tideguard|lungeTell': '!', 'tideguard|pinchTell': '!', 'tideguard|snapTell': '!', 'tideguard|strikeTell': '!',
  'tideguard|thrustTell': '!', 'tidemarauder|castTell': '!', 'tidemarauder|harpoonTell': '!', 'tidemarauder|rakeTell': '!!', 'tidemarauder|reelThrust': '!', 'tidemarauder|thrustTell': '!',
  'tidemarauder|undertowTell': '!!', 'tippler|barTell': '!', 'tippler|heaveTell': '!!', 'tollmaster|blackoutTell': '!', 'tollmaster|darkTell': '', 'tollmaster|ledgerTell': '!',
  ...
  'urchin|hookTell': '!', 'urchin|swellTell': '!', 'wasp|stingTell': '!', 'watch|sweepTell': '!', 'watch|thrustTell': '!', 'winchmaster|cutTell': '!!',
