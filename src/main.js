...
function hurtEnemy(e, dmg, fromX, plunge) {
  ...
  if (e.hp <= 0) {
    ...
    if ((e.t === 'queen' || e.t === 'frog' || e.t === 'chief' || e.t === 'ram') && e.hp <= e.maxHp / 2 && e.phase === 1) { e.phase = 2; number(e.x, e.y - 24, 'ENRAGED', '#ff6b6b'); SFX.roar(); killFlash = 0.06; shakeCam(5); zoomKick(1.08, 0.3); }
  }
}
