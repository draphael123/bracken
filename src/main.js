...
function bakeAll(pal = {}) {
  ...
  PROP.relic.fleece = ART.bakeFleeceIcon(); PROP.relic.lamp = PROP.relic.lamp || PROP.lampIcon; // the miner's lamp relic had no icon: the HUD threw every frame once you held it PROP.relic.windcloak = (() => { const [c, g] = canvas(10, 12); g.fillStyle = '#bfe6f5'; g.beginPath(); g.moveTo(5, 0); g.lineTo(9, 3); g.lineTo(9, 11); g.lineTo(5, 9); g.lineTo(1, 11); g.lineTo(1, 3); g.closePath(); g.fill(); g.fillStyle = '#7aa8c8'; g.fillRect(4, 1, 2, 8); g.fillStyle = '#ffd36b'; g.fillRect(4, 0, 2, 1); return c; })();
