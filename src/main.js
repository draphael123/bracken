...
function updateProps(dt) {
  ...
  updateStals(dt); updateSkyProps(dt); updateCastleProps(dt, hb); updateAlarms(dt); updateGateFx(dt); updateHoly(dt); updateSceptres(dt);
  for (const pr of props) {
