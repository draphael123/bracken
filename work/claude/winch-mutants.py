...
MUT = [
  ...
  ('src/ore-road.js', "{ id: 'B', name: 'THE HEAD FRAME', x0: 476, x1: 480, top: 4,", "{ id: 'B', name: 'THE HEAD FRAME', x0: 476, x1: 480, top: 5,", ['four rows under it']),
  ('src/ore-road.js', "ropes: [[481, 13, 22], [484, 9, 22], [498, 9, 22]]", "ropes: [[481, 13, 22], [484, 8, 22], [498, 9, 22]]", ['one up beside each high ledge']),
  ...
  ('src/ore-road.js', "ladder: [481, 5, 22] },", "ladder: [481, 6, 22] },", ['THE HEAD FRAME: a ladder straight up']),
