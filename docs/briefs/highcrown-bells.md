...
|---|---|---|---|
| **THE OUTER WARD** - the barracks bell | **the chase.** One sentry, a long run (18 tiles) across the open yard to a bell that stands in the open. The first bell of the level: the plain version. | a drop-grate in the inner gate's arch, **321** rows 58-63, in front of the barred gate (322). The wall is over it. | **the barracks turns out of its own door** (315): a soldier and a javelin (two, not three: the ward is already the densest yard in the level), under the counterweight that hangs over that door - cut it on them. |
